...
class Experience {
  ...
  _addMeshes() {
    ...
    var urls = [_prefix + "nx.jpg", _prefix + "ny.jpg", _prefix + "nz.jpg", _prefix + "px.jpg", _prefix + "py.jpg", _prefix + "pz.jpg"];
  ...
  animateIn() {
    ...
    TweenMax.fromTo(this._torus.scale, 0.6, {
      x: 0.8,
      y: 0.8,
      z: 0.8
    }, {
    ...
    TweenMax.fromTo(this._torus.position, 0.6, {
      x: 10,
      y: 20
    }, {
      x: 30,
    ...
    TweenMax.fromTo(this._torus.rotation, 0.6, {
      x: 2.0,
      y: -0.3
    }, {
      x: 2.3,
    ...
    TweenMax.fromTo(this._sphere.scale, 0.6, {
      x: 0.8,
      y: 0.8,
      z: 0.8
    }, {
    ...
    TweenMax.fromTo(this._sphere.position, 0.6, {
      x: -10,
      y: -10
    }, {
      x: -30,
    ...
    TweenMax.fromTo(this._cone.scale, 0.6, {
      x: 0.8,
      y: 0.8,
      z: 0.8
    }, {
    ...
    TweenMax.fromTo(this._cone.position, 0.6, {
      x: -30,
      y: 2,
      z: 3
    }, {
    ...
    TweenMax.fromTo(this._cone.rotation, 0.6, {
      x: -0.2,
      z: 0.0
    }, {
      x: -0.3,
  ...
  resize() {//     this.innerWidth = window.innerWidth
